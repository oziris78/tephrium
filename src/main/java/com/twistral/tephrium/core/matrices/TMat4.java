...
public class TMat4 {
    ...
    public TMat4(double fillValue){
        this(fillValue, fillValue, fillValue, fillValue, fillValue, fillValue, fillValue, fillValue,
                fillValue, fillValue, fillValue, fillValue, fillValue, fillValue, fillValue, fillValue);
    }
    ...
    /**
     * Creates a new double[4][4] object to represent this matrix and returns it.
     * @return this matrix as a double[4][4]
     */
